    ...
    <main class="relative z-10 max-w-6xl mx-auto p-8 pt-12">
      <div class="mb-12">
        <h1 class="text-3xl font-bold tracking-tight text-white">
          Bem-vindo, <span class="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">{{ profile?.name }}</span>
        </h1>
      ...
      <section>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <NuxtLink 
            ...
            class="group glass-card p-4 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl hover:border-purple-500/50 hover:bg-white/[0.08] transition-all duration-500 block"
          >
            <div class="aspect-video rounded-2xl bg-gradient-to-br from-purple-900/40 to-blue-900/40 mb-4 overflow-hidden border border-white/5">
            ...
            <div class="mt-6 pt-4 border-t border-white/5">
               ...
               <div class="flex items-center justify-between mb-2">
                 ...
                 <span class="text-[10px] text-purple-400 font-bold">{{ getCoursePercent(course) }}%</span>
               </div>
               <div class="w-full h-1 bg-white/5 rounded-full overflow-hidden mb-4">
                 <div class="h-full bg-purple-500 transition-all duration-1000" :style="{ width: `${getCoursePercent(course)}%` }"></div>
               </div>
